...
//         (~i_op1[30] & i_op2[30]) |
//         (bit_equal[30] & unsigned_less[31]);

//     assign unsigned_less[29] =
//         (~i_op1[29] & i_op2[29]) |
//         (bit_equal[29] & unsigned_less[30]);

//     assign unsigned_less[28] =
//         (~i_op1[28] & i_op2[28]) |
//         (bit_equal[28] & unsigned_less[29]);

//     assign unsigned_less[27] =
//         (~i_op1[27] & i_op2[27]) |
//         (bit_equal[27] & unsigned_less[28]);

//     assign unsigned_less[26] =
//         (~i_op1[26] & i_op2[26]) |
//         (bit_equal[26] & unsigned_less[27]);

//     assign unsigned_less[25] =
//         (~i_op1[25] & i_op2[25]) |
//         (bit_equal[25] & unsigned_less[26]);

//     assign unsigned_less[24] =
//         (~i_op1[24] & i_op2[24]) |
//         (bit_equal[24] & unsigned_less[25]);

//     assign unsigned_less[23] =
//         (~i_op1[23] & i_op2[23]) |
//         (bit_equal[23] & unsigned_less[24]);

//     assign unsigned_less[22] =
//         (~i_op1[22] & i_op2[22]) |
//         (bit_equal[22] & unsigned_less[23]);

//     assign unsigned_less[21] =
//         (~i_op1[21] & i_op2[21]) |
//         (bit_equal[21] & unsigned_less[22]);

//     assign unsigned_less[20] =
//         (~i_op1[20] & i_op2[20]) |
//         (bit_equal[20] & unsigned_less[21]);

//     assign unsigned_less[19] =
//         (~i_op1[19] & i_op2[19]) |
//         (bit_equal[19] & unsigned_less[20]);

//     assign unsigned_less[18] =
//         (~i_op1[18] & i_op2[18]) |
//         (bit_equal[18] & unsigned_less[19]);

//     assign unsigned_less[17] =
//         (~i_op1[17] & i_op2[17]) |
//         (bit_equal[17] & unsigned_less[18]);

//     assign unsigned_less[16] =
//         (~i_op1[16] & i_op2[16]) |
//         (bit_equal[16] & unsigned_less[17]);

//     assign unsigned_less[15] =
//         (~i_op1[15] & i_op2[15]) |
//         (bit_equal[15] & unsigned_less[16]);

//     assign unsigned_less[14] =
//         (~i_op1[14] & i_op2[14]) |
//         (bit_equal[14] & unsigned_less[15]);

//     assign unsigned_less[13] =
//         (~i_op1[13] & i_op2[13]) |
//         (bit_equal[13] & unsigned_less[14]);

//     assign unsigned_less[12] =
//         (~i_op1[12] & i_op2[12]) |
//         (bit_equal[12] & unsigned_less[13]);

//     assign unsigned_less[11] =
//         (~i_op1[11] & i_op2[11]) |
//         (bit_equal[11] & unsigned_less[12]);

//     assign unsigned_less[10] =
//         (~i_op1[10] & i_op2[10]) |
//         (bit_equal[10] & unsigned_less[11]);

//     assign unsigned_less[9] =
//         (~i_op1[9] & i_op2[9]) |
//         (bit_equal[9] & unsigned_less[10]);

//     assign unsigned_less[8] =
//         (~i_op1[8] & i_op2[8]) |
//         (bit_equal[8] & unsigned_less[9]);

//     assign unsigned_less[7] =
//         (~i_op1[7] & i_op2[7]) |
//         (bit_equal[7] & unsigned_less[8]);

//     assign unsigned_less[6] =
//         (~i_op1[6] & i_op2[6]) |
//         (bit_equal[6] & unsigned_less[7]);

//     assign unsigned_less[5] =
//         (~i_op1[5] & i_op2[5]) |
//         (bit_equal[5] & unsigned_less[6]);

//     assign unsigned_less[4] =
//         (~i_op1[4] & i_op2[4]) |
//         (bit_equal[4] & unsigned_less[5]);

//     assign unsigned_less[3] =
//         (~i_op1[3] & i_op2[3]) |
//         (bit_equal[3] & unsigned_less[4]);

//     assign unsigned_less[2] =
//         (~i_op1[2] & i_op2[2]) |
//         (bit_equal[2] & unsigned_less[3]);

//     assign unsigned_less[1] =
//         (~i_op1[1] & i_op2[1]) |
//         (bit_equal[1] & unsigned_less[2]);

//     assign unsigned_less[0] =
//         (~i_op1[0] & i_op2[0]) |
//         (bit_equal[0] & unsigned_less[1]);
